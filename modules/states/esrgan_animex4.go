...
var esrganAnimeX4Enter statemachine.StateEnterFunction = func(from statemachine.CliState, sm *statemachine.StateMachine) {
	cli.Clear()
...
var ESRGANAnimeX4 = statemachine.NewState(statemachine.ESRGAN_ANIMEX4, esrganAnimeX4Enter, nil, []statemachine.CliState{statemachine.WORKFLOW_FINISH})
